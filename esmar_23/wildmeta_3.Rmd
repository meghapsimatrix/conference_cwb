...
- Example: Kalaian and Raudenbush (1996) data with effects of SAT coaching 
...
- Ignore dependence leads to incorrect standard errors, incorrect inference from hypothesis tests

- Robust variance estimation with CR2 correction plus Satterthwaite degrees of freedom recommended (Tipton, 2015; Tipton and Pustejovsky, 2015)
  
- Such correction controls Type 1 error rates adequately but possibly power especially for __multiple-contrast hypothesis tests__ (Tipton and Pustejovsky, 2015)
  - Examples of multiple contrast hypothesis test: Do effects vary across different outcome measures? 
...
My website: [https://meghapsimatrix.github.io/wildmeta/index.html](https://meghapsimatrix.com)

This presentation: [https://github.com/meghapsimatrix/conference_cwb/tree/main/esmar_23](https://github.com/meghapsimatrix/conference_cwb/tree/main/esmar_23)
---
