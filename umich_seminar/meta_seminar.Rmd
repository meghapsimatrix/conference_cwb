...
- Correlated effects 
  - Multiple outcomes measured on the same sample
  - Multiple treatment conditions compared to the same control
  - Multiple follow-up measures 
  - Multiple correlations from the same sample
  
- Hierarchical effects
  - Studies conducted by the same lab 
...
- Ignore dependence - just run meta-regression 
...
- Requires info on covariance between effect sizes 

- Primary studies often don't report 

- So although this is ideal, we cannot actually use it in practice
...
# Single Coefficient Test of Age
...
# Multiple-Contrast Hypothesis Test
...
# Multiple Contrast Hypothesis: Dependent Variable

To learn more here is a [vignette](https://cran.r-project.org/web/packages/clubSandwich/vignettes/Wald-tests-in-clubSandwich.html#constrain_zer) from `clubSandwich`.
...
knitr::include_graphics("tldr.png")
```
...
- Number of bootstraps set to 399 (to save time and based on prior simulation studies)
...
- Focus on hypothesis testing 
  - Type I error rate - probability of rejecting a null hypothesis when false true
  - Power - probability of rejecting null hypothesis when null is false
...
```{r echo = FALSE, out.height = 450, out.width = 350, fig.align = "center"}
...
```{r echo = FALSE, out.height = 500, out.width = 550, fig.align = "center"}
knitr::include_graphics("plots/type1_05_2.png")
```
...
```{r echo = FALSE, out.height = 400, out.width = 450, fig.align = "center"}
knitr::include_graphics("plots/power_05_scatter_2.png")
```
