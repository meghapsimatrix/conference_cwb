...
- Tipton (2015) for tests of single coefficients (e.g., if treatment effect differs based on the average age of the samples)

- Tipton and Pustejovsky (2015) for multiple-contrast hypothesis tests (e.g., whether treatment effect differ for )

- Both recommended a method - HTZ test (`clubSandwich`)
